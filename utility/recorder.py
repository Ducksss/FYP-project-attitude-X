...
class Recorder():
    def __init__(self, filename):
        ...
        self.video_thread = self.VideoRecorder(self, filename)
        self.audio_thread = self.AudioRecorder(self, filename)
    ...
    def saveRecording(self):
        ...
        stream = ffmpeg.output(video_stream, audio_stream, self.filename +".mp4")
